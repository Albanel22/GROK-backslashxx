...
echo "=== Hooks manuels sucompat (fs/exec.c, fs/open.c, fs/read_write.c, fs/stat.c) ==="
...
hook_insert "fs/read_write.c" \
  'ssize_t vfs_read\(struct file \*file, char __user \*buf, size_t count, loff_t \*pos\)\s*\n\{' \
...
echo "✅ Les 4 hooks sucompat sont en place."
